...
def get_info_text(query):
    try:
        ...
        label['text'] = 'Oops! Something went wrong. Try a different ticker. Thank you!'
...
label = tk.Label(lower_frame, justify='left', wraplength=750, anchor='nw', bd=15, bg='white', image=None)
label.place(relwidth=1, relheight=1)
label['font'] = ("Century Schoolbook", '10')
